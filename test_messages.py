...
def test_live_updates():
    ...
    # 2. TEST STRONG CONFLUENCE (3+ Confirmations)
    print("\n2. Testing Strong Confluence (3+ Confirmations - SL Hit)...")
    ...
    # 3. TEST EXTREME CONFLUENCE (4+ Confirmations)
    print("\n3. Testing Extreme Confluence (4+ Confirmations - TP1 then SL)...")
    indicators_e = [
