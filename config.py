...
SIGNAL_TRADING_THREAD_ID = int(os.getenv("SIGNAL_TRADING_THREAD_ID", "2"))
SIGNAL_GENERAL_THREAD_ID = int(os.getenv("SIGNAL_GENERAL_THREAD_ID", "72"))
SIGNAL_SESSIONS_THREAD_ID = int(os.getenv("SIGNAL_SESSIONS_THREAD_ID", "114"))
SIGNAL_ACTIVE_TRADES_THREAD_ID = int(os.getenv("SIGNAL_ACTIVE_TRADES_THREAD_ID", "76"))
SIGNAL_SCENARIOS_THREAD_ID = int(os.getenv("SIGNAL_SCENARIOS_THREAD_ID", "71"))
SIGNAL_SUCCESS_TRADES_THREAD_ID = int(os.getenv("SIGNAL_SUCCESS_TRADES_THREAD_ID", "435"))
SIGNAL_MESSAGE_THREAD_ID = SIGNAL_TRADING_THREAD_ID
...
BITUNIX_SCENARIO_MIN_PROBABILITY = float(os.getenv("BITUNIX_SCENARIO_MIN_PROBABILITY", "56"))
BITUNIX_SCENARIO_SCAN_INTERVAL_SEC = int(os.getenv("BITUNIX_SCENARIO_SCAN_INTERVAL_SEC", "60"))
BITUNIX_SCENARIO_TRIGGER_COOLDOWN_SEC = int(os.getenv("BITUNIX_SCENARIO_TRIGGER_COOLDOWN_SEC", "10800"))
BITUNIX_AUTO_HEDGE_ENABLED = os.getenv("BITUNIX_AUTO_HEDGE_ENABLED", "true").strip().lower() == "true"
BITUNIX_AUTO_HEDGE_MIN_PROBABILITY = float(os.getenv("BITUNIX_AUTO_HEDGE_MIN_PROBABILITY", "64"))
BITUNIX_AUTO_HEDGE_TRIGGER_R = float(os.getenv("BITUNIX_AUTO_HEDGE_TRIGGER_R", "0.55"))
BITUNIX_AUTO_HEDGE_MAX_PROGRESS_R = float(os.getenv("BITUNIX_AUTO_HEDGE_MAX_PROGRESS_R", "1.10"))
BITUNIX_AUTO_HEDGE_SIZE_MULT = float(os.getenv("BITUNIX_AUTO_HEDGE_SIZE_MULT", "0.45"))
BITUNIX_AUTO_HEDGE_COOLDOWN_SEC = int(os.getenv("BITUNIX_AUTO_HEDGE_COOLDOWN_SEC", "21600"))
...
REVERSAL_OVERRIDE_MIN_SCORE = 6
REVERSAL_OVERRIDE_MIN_PROOFS = 2
WEEKEND_TRADING_ENABLED = False
BOS_GUARD_ENABLED = True
BOS_GUARD_SWING_LOOKBACK = 6
BOS_GUARD_RECENT_BARS = 4
BOS_GUARD_RECLAIM_BARS = 3
STRUCTURE_GUARD_MODE_BY_TF = {
    "5m": "soft",
    "15m": "hard",
    "4h": "off",
}
RSI_PULLBACK_SCALP_ENABLED = True
RSI_PULLBACK_SCALP_TFS = ("5m",)
RSI_PULLBACK_SCALP_OB = 90.0
RSI_PULLBACK_SCALP_OS = 10.0
RSI_PULLBACK_SCALP_MIN_FILTERS = 2
RSI_PULLBACK_SCALP_MIN_EMA_ATR_DISTANCE = 1.5
RSI_PULLBACK_SCALP_MIN_IMPULSE_BODY_ATR = 0.8
RSI_PULLBACK_SCALP_MIN_DISPLACEMENT_ATR = 0.9
RSI_PULLBACK_SCALP_MIN_WICK_BODY_RATIO = 1.2
RSI_PULLBACK_SCALP_TP1_R = 0.6
RSI_PULLBACK_SCALP_TP2_R = 0.9
RSI_PULLBACK_SCALP_TP3_R = 1.2
...
# Bitget BTC funding confirmation bias
BITGET_FUNDING_CONFIRM_ENABLED = os.getenv("BITGET_FUNDING_CONFIRM_ENABLED", "true").strip().lower() == "true"
BITGET_FUNDING_SCORE_THRESHOLD = float(os.getenv("BITGET_FUNDING_SCORE_THRESHOLD", "0.0002"))
BITGET_FUNDING_EXTREME_THRESHOLD = float(os.getenv("BITGET_FUNDING_EXTREME_THRESHOLD", "0.0005"))
BITGET_FUNDING_SCORE_BONUS = int(os.getenv("BITGET_FUNDING_SCORE_BONUS", "1"))
BITGET_FUNDING_COUNTER_BLOCK_SCORE = int(os.getenv("BITGET_FUNDING_COUNTER_BLOCK_SCORE", "8"))
MULTI_EXCHANGE_CONTEXT_ENABLED = os.getenv("MULTI_EXCHANGE_CONTEXT_ENABLED", "true").strip().lower() == "true"
MULTI_EXCHANGE_FUNDING_CONFIRM_ENABLED = os.getenv("MULTI_EXCHANGE_FUNDING_CONFIRM_ENABLED", "true").strip().lower() == "true"
MULTI_EXCHANGE_FUNDING_SCORE_BONUS = int(os.getenv("MULTI_EXCHANGE_FUNDING_SCORE_BONUS", "1"))
MULTI_EXCHANGE_FUNDING_DISAGREE_PENALTY = int(os.getenv("MULTI_EXCHANGE_FUNDING_DISAGREE_PENALTY", "1"))
MULTI_EXCHANGE_FUNDING_BLOCK_MIN_AGREE = int(os.getenv("MULTI_EXCHANGE_FUNDING_BLOCK_MIN_AGREE", "2"))
MULTI_EXCHANGE_LIQ_SCORE_BONUS = int(os.getenv("MULTI_EXCHANGE_LIQ_SCORE_BONUS", "1"))
MULTI_EXCHANGE_LIQ_MIN_USD = float(os.getenv("MULTI_EXCHANGE_LIQ_MIN_USD", "12000000"))
